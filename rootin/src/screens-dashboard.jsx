  ...
  return (
    <div style={{ padding: 32, width: '100%', display: 'flex', flexDirection: 'column', gap: 20, maxWidth: 1600, margin: '0 auto', fontFamily: 'var(--font-body)' }}>
      ...
      <Card padding={24} style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 22 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontFamily: 'var(--font-display)', fontSize: 23, fontWeight: 700, color: 'var(--ink)', marginTop: 6, letterSpacing: '-0.01em' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
        ...
        <Card padding={22} style={{ display: 'flex', flexDirection: 'column', ...CARD_SHEEN }}>

...
function EditorScreen({ onNav, initialSelectedPotId, initialTil }) {
  ...
  return <TilEditorPage onNav={onNav} initialSelectedPotId={initialSelectedPotId} initialTil={initialTil} />;
}

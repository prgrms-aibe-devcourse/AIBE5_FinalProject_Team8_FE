...
const GUIDE_PALETTE = {
  classic: {
    ...
    hintBg: 'var(--ink)',
    hintColor: 'var(--paper)',
    prev: { bg: 'var(--card)', border: '0.5px solid var(--rule-2)', color: 'var(--ink-2)', shadow: 'none' },
    next: { bg: 'var(--moss)', border: 'none', color: 'var(--on-primary)', shadow: 'none' },
    done: { bg: 'var(--ink)', border: 'none', color: 'var(--paper)', shadow: 'none' },
  },
  gameboy: {
